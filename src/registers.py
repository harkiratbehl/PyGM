...
class Registers:
    ...
    def get_next_use(self, line_no, symbol_table):       #returns register with maximum next use
        ...
        for key in self.register_descriptor:
            curr_next_use = symbol_table.symbol_table[self.register_descriptor[key]][0][line_no-1]
